...
const Outbox = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        let res = await ApiService.post(`/wa/get-outbox?limit=25&skip=0`, { tanggal1, tanggal2, jenis });
        console.log(res);
    ...
    return (
        <>
            ...
            <div>{(show) ? <div><AddData2 show={show} onHide={handleClose} Title={modal.title} textBtn={modal.txtBtn} dataApi={satuData}/></div> : ''}</div>
